...
module.exports = async function(deployer, _network, addresses) {
    ...
    //tokenName
    const tokenA = await MockERC20.new('optimusfoxA', 'foxA', web3.utils.toWei('1000'));
    const tokenB = await MockERC20.new('optmiusfoxB', 'foxB', web3.utils.toWei('1000'));
...
//     await deployer.deployed(SushiBar.sushitoken.address);
//     const sushiBar = await SushiBar.deployed();
